...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'twitter_twitteruser', 'lang', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Tweet.lang'
        db.alter_column(u'twitter_tweet', 'lang', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'TwitterUser.lang'
        db.alter_column(u'twitter_twitteruser', 'lang', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Tweet.lang'
        db.alter_column(u'twitter_tweet', 'lang', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'twitter.tweet': {
            ...
            'lang': ('django.db.models.fields.TextField', [], {}),
